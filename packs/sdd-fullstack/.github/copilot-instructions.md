...
- Never let backend or frontend implementation diverge from the agreed API contract
- Never exceed class/component size limits (backend 200 lines, frontend 150 lines)
