...
**`/specify-doc component-spec`** → `component-spec.md` (mvp+; its "Shared Components Used" section is **living/service-level**, see "Living Documents" below) — gate: SRD approved
