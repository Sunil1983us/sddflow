...
> row in that feature's `srd.md`. For project types with no runtime
> service (library, cli-tool, iac): leave as N/A — this table only
> applies when `project_type` exposes a running service or API.
