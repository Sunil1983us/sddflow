...
| CLI / setup | `bash scripts/bash/setup.sh` / PowerShell equivalent | `pip install sddflow` — interactive wizard: project name, scope, AI tool, scaffolds pack automatically |
