...
> Consumed by: frontend-services.instructions.md layer — frontend API
> client/service layer should be generated or hand-written from this spec
...
- [ ] Frontend service layer (frontend-services.instructions.md) request/
      response types match `components.schemas` exactly
