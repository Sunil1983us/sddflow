...
**"Where are the output documents?"** → Most live at `.specify/features/{your-feature}/` — one subfolder per feature. Exceptions: `data-model.md`, `security-design.md`, and `component-library.md` are living, shared across every feature in the app, at `.specify/service/`.
