...
> Lives at `.specify/service/component-library.md`. Every feature that
> introduces a new reusable component, or changes an existing shared
> component's props/behavior, extends this file (see the
