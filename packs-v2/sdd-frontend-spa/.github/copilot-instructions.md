...
Action 2: Generate spec documents per scope:
  ...
  full:  + data-model (Frontend State & Storage Model), resilience
         ...
         Error Tracking), security-design (§1-4)
...
| /plan-arch | PLAN-ARCH | Architecture + plan.md + component-spec/ux-flow/api-spec/data-model/security/resilience refinement |
...
glob to any matching file you create or edit (components/services/tests).
